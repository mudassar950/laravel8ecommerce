                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title text-center"><strong>Edit Permission</strong></h4>

                            <form id="myForm" class="forms-sample" method="POST" action="{{ route('update.permission', ['id' => $permissions->id]) }}">
                                @csrf

                                <div class="form-group mb-3">
                                    <label for="name" class="form-label">Name</label>
                                    <input type="hidden" name="id" id="{{$permissions->id}}">
